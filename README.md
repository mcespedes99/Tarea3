...
<p align="center">
  <img src="https://render.githubusercontent.com/render/math?math=f_{Y}(y)\approx\left(\frac{1}{\sqrt{2%20\pi\cdot36.3235}}%20exp{\left[\frac{-(y-15.0795)^2}{2\cdot36.3235}\right]}\right)">  
</p>  
...
<p align="center">
  <img src="https://render.githubusercontent.com/render/math?math=f_{XY}(x,y)=f_X(x)*f_Y(y)=\left(\frac{1}{\sqrt{2%20\pi\cdot10.8860}}%20exp{\left[\frac{-(x-9.9048)^2}{2\cdot10.8860}\right]}\right)*\left(\frac{1}{\sqrt{2%20\pi\cdot36.3235}}%20exp{\left[\frac{-(y-15.0795)^2}{2\cdot36.3235}\right]}\right)">  
</p>  
